...
Usage:
    ...
    python finetune.py --model HuggingFaceTB/SmolLM2-360M-Instruct
"""
...
# Models to train (all small enough for consumer hardware)
MODELS = [
    "HuggingFaceTB/SmolLM2-360M-Instruct",   # ~200MB quantized
    "Qwen/Qwen2.5-0.5B-Instruct",            # ~350MB quantized
    "Qwen/Qwen2.5-1.5B-Instruct",            # ~1GB quantized
    "HuggingFaceTB/SmolLM2-1.7B-Instruct",   # ~1GB quantized
]
